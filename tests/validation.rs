use prism::validation::{check_data_availability, check_content_semantic, BlockResult};
...
fn validate_block() {
    ...
    assert_result!(check_data_availability(&proposer_1, &blockchain, &blockdb), BlockResult::Pass);
    assert_result!(check_content_semantic(&proposer_1, &blockchain, &blockdb), BlockResult::Pass);
    ...
    assert_result!(check_data_availability(&proposer_2, &blockchain, &blockdb), BlockResult::Pass);
    assert_result!(check_content_semantic(&proposer_2, &blockchain, &blockdb), BlockResult::Pass);
    ...
    assert_result!(check_content_semantic(&proposer_2_fork, &blockchain, &blockdb), BlockResult::WrongProposerRef);
    ...
    for chain in 0..config::NUM_VOTER_CHAINS {
        ...
        assert_result!(check_content_semantic(&voter, &blockchain, &blockdb), BlockResult::WrongVoteLevel);
        ...
        assert_result!(check_content_semantic(&voter, &blockchain, &blockdb), BlockResult::Pass);
        ...
        if chain > 0 {
            ...
            assert_result!(check_content_semantic(&voter, &blockchain, &blockdb), BlockResult::WrongChainNumber);
        }
    }
    ...
    assert_result!(check_content_semantic(&transaction_1, &blockchain, &blockdb), BlockResult::EmptyTransaction);
    ...
    assert_result!(check_content_semantic(&transaction_2, &blockchain, &blockdb), BlockResult::EmptyTransaction);
    ...
    assert_result!(check_content_semantic(&transaction_3, &blockchain, &blockdb), BlockResult::ZeroValue);
    ...
    assert_result!(check_content_semantic(&transaction_4, &blockchain, &blockdb), BlockResult::ZeroValue);
    ...
    assert_result!(check_content_semantic(&transaction_5, &blockchain, &blockdb), BlockResult::InsufficientInput);
    let invalid_tx = Transaction {
    ...
    assert_result!(check_content_semantic(&transaction_6, &blockchain, &blockdb), BlockResult::WrongSignature);
